...
public abstract class ItemMapper {
    ...
    public abstract ItemResourceResponse toResource(Item item);
    ...
    public abstract Item toModel(NewItemResourceRequest itemResource);
    ...
    @Mapping(target = "assignee", ignore = true)
    @Mapping(target = "tags", ignore = true)
    public abstract Item update(ItemUpdateResourceRequest itemResource, @MappingTarget Item item);

    @AfterMapping
    public void afterMapping(NewItemResourceRequest itemResource, @MappingTarget Item item) {
