...
import com.hunesion.testdemor2dbc.exception.JsonProcessingException;
import com.hunesion.testdemor2dbc.exception.NotificationDeserializationException;
                ...
                .handle((notification, sink) -> {
                    ...
                    if (!StringUtils.isBlank(json)) {
                        try {
                            ...
                            Mono.error(new NotificationDeserializationException(topic.name(), e));
                        }
                    }
                });
    }
