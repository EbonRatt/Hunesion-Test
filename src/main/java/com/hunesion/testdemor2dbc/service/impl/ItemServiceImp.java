package com.hunesion.testdemor2dbc.service.impl;

import com.hunesion.testdemor2dbc.enums.NotificationTopic;
import com.hunesion.testdemor2dbc.exception.ItemNotFoundException;
import com.hunesion.testdemor2dbc.exception.UnexpectedItemVersionException;
import com.hunesion.testdemor2dbc.mapper.TagMapper;
import com.hunesion.testdemor2dbc.model.entity.Item;
import com.hunesion.testdemor2dbc.model.entity.ItemTag;
import com.hunesion.testdemor2dbc.repository.ItemRepository;
import com.hunesion.testdemor2dbc.repository.ItemTagRepository;
import com.hunesion.testdemor2dbc.repository.PersonRepository;
import com.hunesion.testdemor2dbc.repository.TagRepository;
...
//        log.info("Item to load Raw: {}", item);
        // Load the tags
...
//        mono.doOnNext(test -> log.info("Item loaded: {}", test)).subscribe();
    ...
    public Flux<Long> listenToDeletedItems() {
        ...
        return this.notificationService.listen(NotificationTopic.ITEM_DELETED, Item.class)
                .map(Item::getId);
    }
